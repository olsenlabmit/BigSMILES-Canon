...
#            _type = 'BigSMILES_ladderBond'
        ...
        if isFirst:
            ...
            if prevBond == None:
                prevBond = ""
                #prevBond = '-'    # TODO uncomment this Bruno
            S_bond = prevBond
        try:    
...
#                return self.G.nodes[thisAtom]['BigSMILES_Bond'].getS_bond(isFirst=False) + smilesStr
    ...
    def place_bonding_descriptors_at_end(self, source, target):
        ...
        Args:
            source: id of the node of the initial bonding descriptor
            target: id of the node of the last bonding descriptor

        Returns: repeating unit with bonding descriptors at the end
